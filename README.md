This is for the react project for udacity. To run the software. clone the repository, change to the directory and run npm install or yarn.

Then run the server with 'npm start'.

The project is using [standard js](https://standardjs.com).
